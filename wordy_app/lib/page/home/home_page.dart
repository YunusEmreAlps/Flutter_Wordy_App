...
import 'package:wordy_app/page/search_page.dart';
import 'package:wordy_app/util/app_constant.dart';
import 'package:wordy_app/util/system_overlay.dart';
import 'package:wordy_app/widget/homepage/tdk_cover.dart';
import 'package:wordy_app/widget/homepage/search_box.dart';
import 'package:wordy_app/widget/homepage/bottom_sheet.dart';
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: _isKeyboardVisible ? SearchPage() : LearnWordsPage(),
                  ),
                ),
              ),
            ],
            ...
            children: <Widget>[
              Padding(
                ...
                child: MaterialButton(
                  ...
                  child: Text(AppConstant.contact, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppConstant.colorHeading)),
                  onPressed: () {
        ...
        children: <Widget>[
          Expanded(
            child: PageView(
              ...
              children: <Widget>[
                AppBottomSheetWidgets.buildKatkiItem(_itemTopMenu(AppConstant.suggestions)),
                AppBottomSheetWidgets.buildIletisimItem(_itemTopMenu(AppConstant.contact)),
              ],
            ),
          ),
          AppBottomSheetWidgets.selectCategory(
            _horizontalCategoryItem(id: 0, title: AppConstant.suggestions),  _horizontalCategoryItem(id: 1, title: AppConstant.contact)),
        ],
      );
